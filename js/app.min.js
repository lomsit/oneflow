...
let slider_about = new Swiper('.sect-dont__row', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
// changing the duration of the animation property in the sect-guide
document.querySelector('.column-first').style.setProperty('--animate-duration', '.55s'); 
document.querySelector('.column-center').style.setProperty('--animate-duration', '.75s');
document.querySelector('.column-last').style.setProperty('--animate-duration', '.95s');
